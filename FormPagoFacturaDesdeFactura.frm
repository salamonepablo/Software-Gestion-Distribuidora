...
' ************ Imprimir el recibo electrónico 2025-07-02 **************************
...
'****************************************************************************
    ...
    respuesta = MsgBox("¿Desea Imprimir Remito y Factura?", vbYesNo, "Facturas")
...
Private Sub Form_Load()
    ...
    FormPagoFacturasDesdeFactura.Height = 9000
    FormPagoFacturasDesdeFactura.Width = 8300
...
'
'    rstUltNum.Index = "PrimaryKey"
'    rstUltNum.Seek "=", "tPagosC", CLng(Left(cmbSucursal.text, 1))
'
'    If Not rstUltNum.NoMatch Then
...
Private Sub calculoabonado()
    ...
    suma = CDec(Format(efectivo, "#00.00")) + CDec(Format(transferencia, "#00.00")) + CDec(Format(rezago, "#00.00")) + CDec(Format(mercaderia, "#00.00")) + CDec(Format(cheque, "#00.00")) + CDec(Format(retencion, "#00.00")) + CDec(Format(tarjeta, "#00.00"))
...
Private Sub calculoresta()
    ...
    If saldoLinea1 = 1 Then
        ...
        If transferencia = 0 Then
            resta = CDec(TextSaldoLinea1.text) - CDec(efectivo) + CDec(transferencia) - CDec(rezago) - CDec(mercaderia) - CDec(cheque) - CDec(retencion) - CDec(tarjeta)
            resta2 = CDec(TextSaldoLinea1.text) - CDec(efectivo) + CDec(transferencia) - CDec(rezago) - CDec(mercaderia) - CDec(cheque) - CDec(retencion) - CDec(tarjeta)
        End If
