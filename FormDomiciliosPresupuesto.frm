...
Begin VB.Form FormDomiciliosPresupuesto 
   ...
   End
End
Attribute VB_Name = "FormDomiciliosPresupuesto"
...
Private Sub BotonSalir_Click()
    ...
    Unload FormDomiciliosPresupuesto

End Sub

Private Sub Form_Load()

    FormDomiciliosPresupuesto.Height = 4905
    FormDomiciliosPresupuesto.Width = 11955
    FormDomiciliosPresupuesto.Top = 3000
    FormDomiciliosPresupuesto.Left = 3000
...
Private Sub MSHFlexGrid1_Click()
    ...
    MSHFlexGrid1.Col = 0
    FormPresupuesto.TextItemDomicilio.Text = MSHFlexGrid1.Text

    MSHFlexGrid1.Col = 1
    FormPresupuesto.TextDireccion.Text = MSHFlexGrid1.Text
    
    MSHFlexGrid1.Col = 2
    FormPresupuesto.TextLocalidad.Text = MSHFlexGrid1.Text
    
    MSHFlexGrid1.Col = 3
    FormPresupuesto.TextCodigoPostal = MSHFlexGrid1.Text
    
    MSHFlexGrid1.Col = 4
    FormPresupuesto.TextProvincia.Text = MSHFlexGrid1.Text
