...
'            rstPresupuestoC.Fields!ImporteDesc = TextDescuentos.Text
            ...
            Do While linea < Filas
                  ...
                  If FG1.text <> "" Then
                        ...
                        FG1.Col = 3
                        rstPresupuestoD.Fields!precioUnitario = Format(FG1.text, "#,###,###,#0.00")
                       ...
                       'Call DesHagoStock(CodProd, descuentoCantidad)
                        ...
                        FG1.Col = 6
                        rstPresupuestoD.Fields!totalLinea = Format(FG1.text, "#,###,###,#0.00")
                        
                        FG1.Col = 7
                        rstPresupuestoD.Fields!ImporteDescuento = Format(FG1.text, "#,###,###,#0.00")
...
'                FG1.Col = 3
'                FG1.Text = Format(rstProductos.Fields!PrecioUnitarioPresupuesto, "#,###,###,#0.00")
'                FG1.Col = FG1.Col + 2
...
'
'            TextSubtotalPresupuesto.Text = Format(total, "#,###,###,#0.00")
'
'            '**** suma descuentos
'
'            columnaSiete = 7
...
'
'            TextTotalPresupuesto.Text = Format(totalPresuForm, "#,###,###,#0.00")
'
