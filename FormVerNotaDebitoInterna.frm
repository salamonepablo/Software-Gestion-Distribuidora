...
Begin VB.Form FormVerNotaDebitoInterna 
   Caption         =   "Consulta Nota Debito Interna"
   ClientHeight    =   8445
   ClientLeft      =   120
   ClientTop       =   450
   ClientWidth     =   12180
   ...
   Begin VB.Frame Frame6 
      ...
      Begin VB.Label Label8 
         AutoSize        =   -1  'True
         Caption         =   "Subtotal Nota Debito Int.:"
         BeginProperty Font 
            Name            =   "MS Sans Serif"
            Size            =   8.25
            Charset         =   0
   ...
   End
End
Attribute VB_Name = "FormVerNotaDebitoInterna"
...
Private Sub GenerarFEB()
        ...
        'Buscar en bbdd
           ...
           Set tNotaDebitoIC = BaseSPC.OpenRecordset("NotaDebitoIC", dbOpenTable)
'          Set tNotaDebitoID = BaseSPC.OpenRecordset("NotaDebitoID", dbOpenTable)
           ...
           'tNotaDebitoIC.Seek "=", FormFactura.TextTipoFactura.Text, FormImprimir.TextNumeroFactura.Text
           'tNotaDebitoIC.Seek "=", "A", TextNumeroFactura.Text
           tNotaDebitoIC.Seek "=", TextTipoFactura.text, TextNumeroFactura.text
            
           If Not tNotaDebitoIC.NoMatch Then
                
                'If IsNull(tNotaDebitoIC!CAE) Then
                ...
                With Printer
                    ...
                    'Datos de La Empresa y Comprobante
                        ...
                        .FontSize = 12
                        .FontBold = True
                        Printer.Print "NOTA DE DEBITO INTERNA"
                        ...
                        .DrawWidth = 6
                        Printer.Line (105, 17)-(114, 17)
                        Printer.Line (105, 17)-(105, 25)
                        Printer.Line (114, 17)-(114, 25)
                        Printer.Line (114, 25)-(105, 25)
                        ...
                        NroFactura = CStr(tNotaDebitoIC!NroDebitoI)
                        Largo = 8 - Len(tNotaDebitoIC!NroDebitoI)
                        For I = 1 To Largo
                        ...
                        Printer.Print "Fecha: " & Format(tNotaDebitoIC!FechaDebitoI, "DD/MM/YYYY")
                    ...
                    'Datos del Cliente
                        tClientes.MoveFirst
                        tClientes.Seek "=", tNotaDebitoIC!CodCliente
                        If Not tClientes.NoMatch Then
                         ...
                         'Condiciones de venta
                            'Recuadro
                                ...
                                .FontSize = 10
                                .FontBold = False
                                Printer.Print tNotaDebitoIC!CondicionVenta
                                ...
                                'NroRemito = CStr(tNotaDebitoIC!NroRemito)
                                'LargoR = 8 - Len(tNotaDebitoIC!NroRemito)
                                'For I = 1 To LargoR
                     ...
                     'Recuadro Detalle
                       ...
                       'Imprimir Detalle de La Factura
                        ...
                        'vSQL = "SELECT * FROM NotaDebitoID WHERE NroDebito=" & tNotaDebitoIC!NroDebitoI & " ORDER BY NroDebitoI, ItemDebitoI"
                        vSQL = "SELECT * FROM NotaDebitoID WHERE TipoDebitoI='" & tNotaDebitoIC!TipoDebitoI & "' AND NroDebitoI=" & tNotaDebitoIC!NroDebitoI & " ORDER BY NroDebitoI, ItemDebitoI"
                        'MsgBox (vSQL)
                        
                        Set tNotaDebitoID = BaseSPC.OpenRecordset(vSQL)
                        
                        tNotaDebitoID.MoveFirst
                        linea = .CurrentY + 3
                        
                        While Not tNotaDebitoID.EOF
                            .FontBold = True
                            .CurrentX = 14
                            .CurrentY = linea
                            .Font = "Courier New"
                            ...
                            .FontSize = 10
                           ' .FontBold = False
                            Cant = CDbl(tNotaDebitoID!cantidad)
                            ...
                            Next I
                            Printer.Print Cant
                            'Printer.Print Format(tNotaDebitoID!cantidad, "Standard")
                           ...
                           ' .FontBold = False
                            .FontSize = 10
                            Printer.Print Descripcion(tNotaDebitoID!IdCodProd)
                           ...
                           ' .FontBold = False
                            ...
                            PU = (CDbl(tNotaDebitoID!precioUnitario) - (CDbl(tNotaDebitoID!precioUnitario) * CDbl(tNotaDebitoID!PorcentajeDescuento) / 100))
                            ...
                            .FontSize = 10
                           ' .FontBold = False
                            TL = Format((PU * tNotaDebitoID!cantidad), "Standard")
                     ...
                     '       .FontName = "Courier New"
                     '       SubTotalFac = Format(CDbl(tNotaDebitoIC!SubTotalFactura), "Standard")
                     ...
                     '       .FontSize = 10
                            '.FontBold = False
                     '       ImpIva = Format(CDbl(tNotaDebitoIC!TotalIVA), "Standard")
                     ...
                     '   If tNotaDebitoIC!ImportePercepIIBB > 0 Then
                            'Alicuota IIBB
                     '           .CurrentX = 135
                     '           .CurrentY = 255
                     '           .Font = "Arial"
                     '           .FontSize = 10
                                '.FontBold = False
                     '           Printer.Print "Per.IIBB: " & tNotaDebitoIC!AlicuotaIIBB & "%:"
                     ...
                     '           .Font = "Courier New"
                      ''          .FontSize = 10
                                '.FontBold = False
                     '           ImpIIBB = Format(CDbl(tNotaDebitoIC!ImportePercepIIBB), "Standard")
                     ...
                     '   End If
                        ...
                        'Importe Total
                            ...
                            .ForeColor = vbWhite
                            Printer.Print "TOTAL: "
                            TotalFac = Format(CDbl(tNotaDebitoIC!TotalDebitoI), "Standard")
                ...
                End With
             Else
                A = MsgBox("Nota de Débito Interna Inexistente !!!", vbCritical, "E R R O R")
        End If
...
Private Sub Imprimir()
    ...
    With Printer
        ...
        'Imprimir Detalle
            ...
            vsqlFC = "SELECT * FROM NotaDebitoIC WHERE TipoDebito='" & TextTipoFactura.text & "' AND NroDebito=" & TextNumeroFactura.text & " ORDER By NroDebito"
            vsqlFD = "SELECT * FROM NotaDebitoID WHERE TipoDebito='" & TextTipoFactura.text & "' AND NroDebito=" & TextNumeroFactura.text & " ORDER By NroDebito"
...
Private Sub ImprimirFEB()
        ...
        'Buscar en bbdd
           ...
           Set tNotaDebitoC = BaseSPC.OpenRecordset("NotaDebitoIC", dbOpenTable)
'          Set tNotaDebitoD = BaseSPC.OpenRecordset("NotaDebitoID", dbOpenTable)
           Set tClientes = BaseSPC.OpenRecordset("Clientes", dbOpenTable)
           Set tDomiciliosClientes = BaseSPC.OpenRecordset("DomiciliosClientes", dbOpenTable)
                    ...
                    'Datos del Cliente
                     ...
                     'Recuadro Detalle
                       ...
                       'Imprimir Detalle de La Factura
                        ...
                        'vSQL = "SELECT * FROM NotaDebitoID WHERE NroDebito=" & tNotadebitoC!NroDebito & " ORDER BY NroDebito, ItemDebito"
                        vSQL = "SELECT * FROM NotaDebitoID WHERE TipoDebito='" & tNotaDebitoC!TipoDebito & "' AND NroDebito=" & tNotaDebitoC!NroDebito & " ORDER BY NroDebito, ItemDebito"
                        'MsgBox (vSQL)
...
Private Sub BotonSalir_Click()
    ...
    Unload FormVerNotaDebitoInterna
                       ...
                       'Imprimir Detalle de La Factura
                        ...
                        While Not tNotaDebitoID.EOF
                           ...
                           ' .FontBold = False
                            ...
                            .FontSize = 10
                           ' .FontBold = False
                            TL = Format(tNotaDebitoID!totalLinea, "Standard")
                            Hasta = CInt(14 - Len(TL))
                            For I = 0 To Hasta
                                TL = " " & TL
                            Next I
                        ...
                        'Importe SubTotal
                            ...
                            Printer.Print ("Sub Total: ")
                            .FontName = "Courier New"
                            SubTotalFac = Format(CDbl(tNotaDebitoIC!SubTotalDebitoI), "Standard")
                            Hasta = CInt(14 - Len(SubTotalFac))
                            For I = 0 To Hasta
                                SubTotalFac = " " & SubTotalFac
                            Next I
...
Private Sub Form_Load()
    ...
    FormVerNotaDebitoInterna.Height = 8970
    FormVerNotaDebitoInterna.Width = 12135
    FormVerNotaDebitoInterna.Top = 1000
    FormVerNotaDebitoInterna.Left = 1000
...
'    codCli = Val(FormMovimientosCuentaCorriente.TextCodigoCliente)
    ...
    If CDbl(FormBuscarNDInterna.TextA) = 1 Then
        codCli = Val(FormBuscarNDInterna.TextCodigoCliente)
        numDoc = Val(FormBuscarNDInterna.TextNumeroFactura)
        tipoDoc = FormBuscarNDInterna.TextTipo
        Call SeteoGrilla
        Call buscofactura
    End If
...
'    Set db = DBEngine.OpenDatabase(ruta)
'    Set rstNotaDebitoC = db.OpenRecordset("NotaDebitoIC", dbOpenDynaset)

'    Set db = DBEngine.OpenDatabase(ruta)
'    Set rstNotaDebitoD = db.OpenRecordset("NotaDebitoID", dbOpenDynaset)
...
'
'    Set rstNotaDebitoC = db1.OpenRecordset("NotaDebitoIC", dbOpenDynaset)
'
...
'    rstNotaDebitoC.FindFirst "NroFactura= " + Str(numDoc)
    ...
    Set rstNotaDebitoC = db1.OpenRecordset("NotaDebitoIC", dbOpenTable)
    ...
    TextNumeroFactura.text = rstNotaDebitoC.Fields!NroDebitoI
    TextTipoFactura.text = rstNotaDebitoC.Fields!TipoDebitoI
    TextFechaFactura.text = rstNotaDebitoC.Fields!FechaDebitoI
...
'    rstNotaDebitoD.FindFirst "NroFactura= " + Str(numDoc)
    ...
    'Set rstNotaDebitoD = db2.OpenRecordset("NotaDebitoID", dbOpenTable)

    vSQL = "SELECT * FROM NotaDebitoID WHERE TipoDebitoI='" & tipoDoc & "' AND NroDebitoI=" & numDoc & " ORDER BY ItemDebitoI"
   ...
   While Not rstNotaDebitoD.EOF
    ...
    TextSubtotalFactura.text = Format(rstNotaDebitoC.Fields!SubTotalDebitoI, "#,###,###,#0.00")
'    TextDescuentos.Text = rstNotaDebitoC.Fields!ImporteDesc
    ...
    TextTotalFactura.text = Format(rstNotaDebitoC.Fields!TotalDebitoI, "#,###,###,#0.00")
...
Private Function CalcularBarCode() As String
    ...
    If tNotaDebitoIC!TipoDebitoI = "A" Then TipoC = "00"
    If tNotaDebitoIC!TipoDebitoI = "B" Then TipoC = "00"
    
    FechaVC = tNotaDebitoIC!FechaDebitoI
    'Year(tNotaDebitoC!FechaVC) & Format(Month(tNotaDebitoC!FechaVC), "00") & Format(Day(tNotaDebitoC!FechaVC), "00")
    
    'MsgBox (FechaVC)

    CalcularBarCode = "30708432543" & TipoC & "0004" & tNotaDebitoIC!CAE & FechaVC & CalculoDigitoVerificador("30708432543")
