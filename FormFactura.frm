...
Begin VB.Form FormFactura 
   ...
   Begin VB.Frame Frame3 
      ...
      Top             =   1560
      Width           =   11655
      Begin VB.ComboBox comboCondicionVta 
         Height          =   315
         ItemData        =   "FormFactura.frx":0000
         Left            =   9360
         List            =   "FormFactura.frx":0002
...
Private Const MB_DEFBUTTON2 As Long = &H100 ' Segundo botón por defecto (No)
...
'///Declaraciones para FE SPC
    ...
    '**************************************************
        ...
        db1.Close
            ...
            rstFacturaC.Fields!CondicionVenta = comboCondicionVta.text
                        
        '//Solicitud de aclaracion en la factura 2025-04-09
            'Rta = MsgBox("¿Desea Agregar una Aclaración en la Factura?", vbYesNo, "Aclaración")
                 
            'If Rta = vbYes Then
            '    rstFacturaC.Fields!AclaracionFactura = InputBox("Ingrese Aclaración", "SPCSI Observaciones")
            ' Else
        ...
        '//********************************************************************
         ...
         Dim Rta As Long
            Rta = MessageBox(Me.hwnd, "¿Desea Agregar una Aclaración en la Factura?", "Aclaración", MB_YESNO Or MB_DEFBUTTON2)
...
'///////////////////////FIN FE SPC //////////////////////////////////////////////////////////////////////////////////////
 ...
 '               If Not FacturaElectronicaSPC(PtoVta, DocTipo, DocNro, TipoComp, CbteDesde, CbteHasta, CbteFch, ImpTotal, ImpNeto, MonId, MonCotiz, AlicIVA, BaseImpIVA, ImpIva, IdTributo, DescTributo, BaseImpTributo, Alicuota, ImpAlicuota, ImporteExento) Then
 '
 '                   Call RevertirFactura(DocTipo, DocNro)
 '
 '               End If
 '
...
Private Sub Cargo()
    ...
    Set rstCondicionVenta = db.OpenRecordset("CondicionVenta", dbOpenTable)
    ...
    rstCondicionVenta.MoveFirst
       
    While Not rstCondicionVenta.EOF
        comboCondicionVta.AddItem rstCondicionVenta!IdCV & " - " & rstCondicionVenta!CondicionVenta
        rstCondicionVenta.MoveNext
    Wend
    comboCondicionVta.ListIndex = 1
