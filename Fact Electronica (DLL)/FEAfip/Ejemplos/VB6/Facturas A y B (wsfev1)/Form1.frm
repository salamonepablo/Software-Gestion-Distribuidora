...
Private Sub Command1_Click()
        ...
        Reproceso$ = ""
        nro = 0
        PtoVta = 1  ' ATENCION! SI RECIBE UN ERROR DE FECHA O NUMERO DE COMPROBANTE EN ESTA DEMO CAMBIE ESTE VALOR POR OTRO DE 1 A 9999
        ...
        If wsfev1.login("certificado.crt", "clave.key", URLWSAA) Then
            ...
            Else
                nro = nro + 1
                wsfev1.Reset
                wsfev1.AgregaFactura 1, 80, 11111111111#, nro, nro, FechaComp, 121, 0, 100, 0, "", "", "", "PES", 1
