VERSION 5.00
Begin VB.Form FormImprimirNDInt 
   Caption         =   "Imprimir"
   ClientHeight    =   3015
   ClientLeft      =   120
   ClientTop       =   450
   ...
   End
End
Attribute VB_Name = "FormImprimirNDInt"
...
Private Function CalcularBarCode() As String
    ...
    FechaVC = Year(tNotaDebitoIC!FechaDebitoI) & Format(Month(tNotaDebitoIC!FechaDebitoI), "00") & Format(Day(tNotaDebitoIC!FechaDebitoI), "00")
    
  '  MsgBox (FechaVC)

    CalcularBarCode = "30708432543" & TipoC & "0004" & "99999999999999" & FechaVC & CalculoDigitoVerificador("30708432543")
...
Private Sub BotonSalir_Click()
    ...
    Call FormNDInterna.blanqueototal
        
    FormNDInterna.TextCodigoCliente.SetFocus
    FormNDInterna.MSFlexGrid1.Visible = False
    'FormNDInterna.FG1.Visible = False
                  
    Unload FormImprimirNDInt
