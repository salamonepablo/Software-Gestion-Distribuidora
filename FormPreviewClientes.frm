...
Begin VB.Form FormPreviewClientes 
   Caption         =   "Form1"
   ClientHeight    =   8910
   ClientLeft      =   750
   ClientTop       =   525
   ...
   End
End
Attribute VB_Name = "FormPreviewClientes"
...
Set repRep = RepApp.OpenReport(App.Path & "\Clientes.rpt")
...
CRV.Left = 0
CRV.Top = 0
CRV.Height = FormPreviewClientes.Height - 120
CRV.Width = FormPreviewClientes.Width - 120
End Sub
