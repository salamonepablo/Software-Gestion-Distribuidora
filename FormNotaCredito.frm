        ...
        db1.Close
            ...
            Do While linea < Filas
                  ...
                  If FG1.text <> "" Then
                        ...
                        FG1.Col = 3
                        rstNotaCreditoD.Fields!precioUnitario = Format(FG1.text, "#,###,###,#0.00")
                       ...
                       'Call DesHagoStock(CodProd, descuentoCantidad)
                        ...
                        FG1.Col = 6
                        rstNotaCreditoD.Fields!totalLinea = Format(FG1.text, "#,###,###,#0.00")
                        
                        FG1.Col = 7
                        rstNotaCreditoD.Fields!ImporteDescuento = Format(FG1.text, "#,###,###,#0.00")
...
'
'            TextTotalNotaCredito.Text = Format(TotalNotaCreditoForm, "#,###,###,#0.00")
'
