...
Begin VB.Form FormBusquedaProductosPresupuesto 
   ...
   End
End
Attribute VB_Name = "FormBusquedaProductosPresupuesto"
...
Private Sub BotonSalir_Click()
    ...
    Unload FormBusquedaProductosPresupuesto
...
Private Sub Form_Load()
    ...
    FormBusquedaProductosPresupuesto.Height = 5610
    FormBusquedaProductosPresupuesto.Width = 9975
...
Private Sub MSFlexGrid1_DblClick()
    ...
    If FormPresupuesto.FG1.Row = 0 Then
        FormPresupuesto.FG1.Row = FormPresupuesto.FG1.Row + 1
    End If
    
    FormPresupuesto.FG1.Col = 0
    
    'If FormPresupuesto.FG1.Text <> "" Then
        
        If FormPresupuesto.FG1.Row >= 15 Then
        ...
        Else
             ...
             MSFlexGrid1.Col = 0
             FormPresupuesto.FG1.Col = 0
             FormPresupuesto.FG1.Text = MSFlexGrid1.Text
        
             MSFlexGrid1.Col = 1
             FormPresupuesto.FG1.Col = 1
             FormPresupuesto.FG1.Text = MSFlexGrid1.Text
         
             MSFlexGrid1.Col = 2
             FormPresupuesto.FG1.Col = 2
             FormPresupuesto.FG1.Text = MSFlexGrid1.Text
         
             MSFlexGrid1.Col = 3
             FormPresupuesto.FG1.Col = 3
             FormPresupuesto.FG1.Text = MSFlexGrid1.Text
        End If
