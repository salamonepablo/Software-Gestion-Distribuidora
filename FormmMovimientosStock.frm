...
Begin VB.Form FormMovimientosStock 
   ...
   Begin VB.Frame Frame1 
      ...
      Top             =   0
      Width           =   11415
      Begin VB.CommandButton cmdConsultarStock 
...
Private Sub btnEliminar_Click()
    ...
    If Rta = 1 Then
        ...
        'Seteo la Tabla detalle para poder deshacer los movimientos de Stock
            vSQL = "SELECT * FROM MovIntStockD WHERE IdMovInt =" & tMovIntStockC!IdMovIntStock & " ORDER BY ItemMov"
            ...
            While Not tMovIntStockD.EOF
                ...
                Call DesHagoStock(tMovIntStockD!IdCodProd, IdDepoOrigen, IdDepoDestino, tMovIntStockD!cantidad)
                tMovIntStockD.MoveNext
        ...
        'Elimino la cabecera y por cascada elimina el detalle
...
Private Sub cmdConsultarStock_Click()

    FormConsultarStock.Show

End Sub

Private Sub cmdConsultarStock_KeyPress(KeyAscii As Integer)
...
Private Sub txtIdMov_GotFocus()
    ...
    txtIdMov.SelLength = Len(txtIdMov.Text)
End Sub
