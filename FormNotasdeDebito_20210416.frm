...
'            rstNotaDebitoC.Fields!ImporteDesc = TextDescuentos.Text
     ...
     '/////////  GENERAMOS LA FACTURA ELECTRONICA DESDE SPC /////////////////////////////
                ...
                If TipoComp = 2 Then ImpNeto = Format(CDbl(TextSubtotalFactura.Text), "Standard")
                If TipoComp = 7 Then ImpNeto = Format(CDbl(TextTotalFactura.Text), "Standard")
                ...
                If TipoComp = 2 Then BaseImpIVA = Format(CDbl(TextSubtotalFactura.Text), "Standard")
                If TipoComp = 7 Then BaseImpIVA = ImpNeto
                ...
                If TipoComp = 2 Then BaseImpTributo = Format(CDbl(TextSubtotalFactura.Text), "Standard")
    ...
    If A >= 4 Then
        ...
        Do While Not tClientes.EOF()
                ...
                With Me.MSFlexGrid1
                    ...
                    End If
                    MSFlexGrid1.Col = 3
                    If tClientes.Fields!Domicilio <> "" Then MSFlexGrid1.Text = tClientes.Fields!Domicilio
                    MSFlexGrid1.Col = 4
                    If tClientes.Fields!localidad <> "" Then MSFlexGrid1.Text = tClientes.Fields!localidad
                    MSFlexGrid1.Col = 5
                    If tClientes.Fields!CP <> "" Then MSFlexGrid1.Text = tClientes.Fields!CP
                    
                    MSFlexGrid1.Col = 6
                    If tClientes.Fields!Prov <> "" Then MSFlexGrid1.Text = tClientes.Fields!Prov
                    
                    MSFlexGrid1.Col = 7
                    If tClientes.Fields!PorcentajeDescuento Then MSFlexGrid1.Text = tClientes.Fields!PorcentajeDescuento
        ...
        Else
            ...
            Else
               ...
               'If TextCuit.Text <> "" Then TextCuit.Text = rstCliente.Fields!Cuit
                If TextCuit.Text = "" Then TextCuit.Text = rstCliente.Fields!CUIT
                If rstCliente.Fields!Domicilio <> "" Then TextDireccion.Text = rstCliente.Fields!Domicilio
                If rstCliente.Fields!localidad <> "" Then TextLocalidad.Text = rstCliente.Fields!localidad
                If rstCliente.Fields!CP <> "" Then TextCodigoPostal.Text = rstCliente.Fields!CP
                If rstCliente.Fields!Prov <> "" Then TextProvincia.Text = rstCliente.Fields!Prov
