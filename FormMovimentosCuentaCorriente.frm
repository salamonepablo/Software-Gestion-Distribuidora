...
Private Function CalculoFechaDesde(FechaHoy As Date)
...
'    NombreImpresora = "CutePDF Writer"
...
Private Sub ImprimirMovimientosPDF()

Dim x As Printer
Dim NombreImpresora As String
Dim NombreImpDefault As String
   
    NombreImpDefault = Printer.DeviceName
...
'    MsgBox (Printer.DeviceName)
    ...
    With objPrinterFlex
      ...
      'del texto y el tamaño de la fuente
        ...
        '            nVendedor = Chr(9) & cmbVendedores(1).Text
                    ...
                    Pie = Chr(9) & Chr(9) & "Saldo Línea 1: " & FormatCurrency(TextSaldoLinea1.text, 2) & Chr(9) & "Saldo Línea 2: " & FormatCurrency(TextSaldoLinea2.text, 2) & Chr(9) & "Saldo Total: " & FormatCurrency(TextSaldoTotal.text, 2)
    ...
    NombreImpresora = NombreImpDefault
...
'    While CVDate(tMovCC!Fecha) > CVDate(TextFechaDesde.Text)
        ...
        If Not tMovCC.EOF Then tMovCC.MoveNext
    Wend
   ...
   ' lblSaldoAnterior.Caption = " Línea 1: $ " + CStr(CCur(SaldoL1)) + "     Línea 2: $ " + CStr(CCur(SaldoL2)) + "     Saldo Anterior Consolidado: $ " + CStr(CCur(SaldoTotal))
    ...
    Do While Not rst.NoMatch
         ...
         If OptionTodo.Value = True Then
            ...
            MSFlexGrid2.Col = 7
            MSFlexGrid2.text = CDbl(rst.Fields!Fecha)
            MSFlexGrid2.ColWidth(7) = 0
            'Format$(rst.Fields!Fecha, "DD/MM/YYYY")
            MSFlexGrid2.Col = 1
            ...
            MSFlexGrid2.Col = 3
            MSFlexGrid2.text = Format(rst.Fields!ImporteLinea1, "#,###,###,#0.00")
            saldoLinea1 = saldoLinea1 + rst.Fields!ImporteLinea1
            MSFlexGrid2.Col = 4
            MSFlexGrid2.text = Format(rst.Fields!ImporteLinea2, "#,###,###,#0.00")
            ...
            End If
             If rst.Fields!tipoDoc = "Debito A" Or rst.Fields!tipoDoc = "Debito B" Then
               MSFlexGrid2.Col = 6
               MSFlexGrid2.text = "DEBITO"
            End If
            
            If rst.Fields!tipoDoc = "Debito Int. A" Or rst.Fields!tipoDoc = "Debito Int. B" Then
               MSFlexGrid2.Col = 6
               MSFlexGrid2.text = "DEBITO INTERNO"
            End If
...
'            *** original *****
'            If rst.Fields!tipoDoc = "Factura A" Or rst.Fields!tipoDoc = "Factura B" Or rst.Fields!tipoDoc = "Pago Linea 1" Or rst.Fields!tipoDoc = "Nota Credito A" Or rst.Fields!tipoDoc = "Nota Credito B" Or rst.Fields!tipoDoc = "Debito A" Or rst.Fields!tipoDoc = "Debito B" Then

             vAnulacionPago = Left(rst.Fields!tipoDoc, 14) & " " & Right(rst.Fields!tipoDoc, 1)

             If rst.Fields!tipoDoc = "Factura A" Or rst.Fields!tipoDoc = "Factura B" Or rst.Fields!tipoDoc = "Pago Linea 1" Or rst.Fields!tipoDoc = "Nota Credito A" Or rst.Fields!tipoDoc = "Nota Credito B" Or rst.Fields!tipoDoc = "Debito A" Or rst.Fields!tipoDoc = "Debito B" Or vAnulacionPago = "Anulacion Pago 1" Then
          
  
                MSFlexGrid2.AddItem " "
                MSFlexGrid2.Row = linea2
                MSFlexGrid2.Col = 0
                MSFlexGrid2.text = Format$(rst.Fields!Fecha, "DD/MM/YYYY")
...
''            If rst.Fields!tipoDoc = "Pago Linea 2" Or rst.Fields!tipoDoc = "Presupuesto" Or Left(rst.Fields!tipoDoc, 14) = "Anulacion Pago" Then
            ...
            If rst.Fields!tipoDoc = "Pago Linea 2" Or rst.Fields!tipoDoc = "Presupuesto" Or vAnulacionPago = "Anulacion Pago 2" Or Left(rst.Fields!tipoDoc, 21) = "Anulacion Presupuesto" Then
...
Error_Handler:
    ...
    If MSFlexGrid2.Rows = 2 Then
     'Para evitar error 30015
     Else
        MSFlexGrid2.RemoveItem (MSFlexGrid2.Rows)
    End If
...
Private Sub cmPDF_Click()

    Call ImprimirMovimientosPDF
...
Private Sub MSFlexGrid1_Click()
   ...
   'Metodo de ordenamiento
    ...
    If (MSFlexGrid1.MouseRow = 0) Then
        ...
        Else
            MSFlexGrid1.Col = MSHFlexGrid1.MouseCol
            MSFlexGrid1.Sort = 1
            Modo = True
        End If
    End If
        Me.Caption = " Ordenando por la columna: " & MSFlexGrid1.MouseCol
...
Private Sub MSFlexGrid2_DblClick()
   ...
   MSFlexGrid2.Col = 1
   TextTipodocumento.text = MSFlexGrid2.text
   If TextTipodocumento.text = "Debito A" Then
        TextTipodocumento.text = "A"
   End If
   
   If TextTipodocumento.text = "Debito B" Then
        TextTipodocumento.text = "B"
   End If
   ...
   If TextDocumento.text = "DEBITO" Then
      FormVerNotaDebitoCtaCte.Show
   End If
   
   If TextDocumento.text = "DEBITO INTERNO" Then
      FormVerNotaDebitoIntCtaCte.Show
   End If
...
Private Sub Form_Load()
    ...
    FDesde = CLng(Date) - 182
    
    TextFechaDesde.text = Format(FDesde, "dd/mm/yyyy")
