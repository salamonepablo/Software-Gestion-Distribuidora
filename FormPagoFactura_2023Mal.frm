...
Private Sub ImprimirReciboE()
        ...
        Dim vEfete, vCheques, vRetenciones
        ...
        'Buscar en bbdd
           ...
           tUltimosNumeros.Seek "=", "tRecibosC"
           NroRecibo = 0
           NroRecibo = (CInt(tUltimosNumeros!UltimoNumero) + 1)
                ...
                With Printer
                    ...
                    'Datos de La Empresa y Comprobante
                      ...
                      '  Printer.Line (93, 25)-(102, 25)
                        ...
                        Next I
                        Printer.Print "Nº: 0004-" & NroRecibo
                       ...
                       'Imprimir Detalle del Recibo
                          ...
                          '  .FontName = "Courier New"
                           ' .FontBold = False
                            ...
                            Printer.Print "* Efectivo:               " & Format(vEfete, "Currency")
                          ...
                          '  .FontName = "Courier New"
                           ' .FontBold = False
                            ...
                            Printer.Print "* Cheques Varios: " & Format(vCheques, "Currency")
                          ...
                          '  .FontName = "Courier New"
                           ' .FontBold = False
                            ...
                            Printer.Print "* Retenciones:        " & Format(vRetenciones, "Currency")
...
Private Sub TextCheque_LostFocus()
    ...
    If TextCheque.text <> "" Then TextCheque.text = Format(TextCheque.text, "#,###,###,#0.00")
...
Private Sub TextEfectivo_LostFocus()
    ...
    If TextEfectivo.text <> "" Then TextEfectivo.text = Format(TextEfectivo.text, "#,###,###,#0.00")
...
Private Sub TextMercaderia_LostFocus()

    If TextMercaderia.text <> "" Then TextMercaderia.text = Format(TextMercaderia.text, "#,###,###,#0.00")
...
Private Sub TextRetencion_LostFocus()

    If TextRetencion.text <> "" Then TextRetencion.text = Format(TextRetencion.text, "#,###,###,#0.00")
...
Private Sub calculoabonado()
    ...
    suma = CDbl(Format(efectivo, "#,###,###,#0.00")) + CDbl(Format(rezago, "#,###,###,#0.00")) + CDbl(Format(mercaderia, "#,###,###,#0.00")) + CDbl(Format(cheque, "#,###,###,#0.00")) + CDbl(Format(retencion, "#,###,###,#0.00")) + CDbl(Format(tarjeta, "#,###,###,#0.00"))
...
Private Sub calculoabonadoresta()
    ...
    'suma = CDec(efectivo) + CDec(rezago) - CDec(mercaderia) - CDec(cheque) - CDec(retencion) - CDec(tarjeta)
    suma = CDbl(efectivo) + CDbl(rezago) - CDbl(mercaderia) - CDbl(cheque) - CDbl(retencion) - CDbl(tarjeta)
    LabelTotalAbonado.Caption = Format(suma, "#,###,###,#0.00")
...
Private Sub TextRezago_LostFocus()

    If TextRezago.text <> "" Then TextRezago.text = Format(TextRezago.text, "#,###,###,#0.00")
...
Private Sub TextTarjeta_LostFocus()

    If TextTarjeta.text <> "" Then TextTarjeta.text = Format(TextTarjeta.text, "#,###,###,#0.00")
