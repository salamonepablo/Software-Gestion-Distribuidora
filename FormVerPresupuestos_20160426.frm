         ...
         If respuesta = vbYes Then
           ...
           '     On Error GoTo CapturaErrores
                ...
                descuentoCantidad = Val(FG1.Text)
                 ...
                 Else
                     rstCtaCte.Edit
                     saldo1 = Val(Format(rstCtaCte.Fields!SaldoL1, "#0.00"))
                     saldo2 = Val(Format(rstCtaCte.Fields!SaldoL2, "#0.00"))
                     saldoLi2 = Val(Format(TextTotalPresupuesto.Text, "#0.00"))
                     rstCtaCte.Fields!SaldoL2 = saldo2 - saldoLi2
                     saldo2 = Val(Format(rstCtaCte.Fields!SaldoL2, "#0.00"))
                     rstCtaCte.Fields!SaldoTotal = saldo2 + saldo1
                     rstCtaCte.Update
                 End If
...
'    End If
   ...
   LegajoEmpleado = rstEmpleado.Fields!Legajo
    ...
    TextSubtotalPresupuesto.Text = rstPresupuestoC.Fields!SubTotalPresu
    
    If rstPresupuestoC.Fields!ImporteDesc <> "" Then
        TextDescuentos.Text = rstPresupuestoC.Fields!ImporteDesc
    End If
    
    TextTotalPresupuesto.Text = rstPresupuestoC.Fields!TotalPresu
