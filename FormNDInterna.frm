...
Begin VB.Form FormNDInterna 
   Caption         =   "Notas de Debito Interna"
   ClientHeight    =   9540
   ClientLeft      =   120
   ClientTop       =   450
   ClientWidth     =   12630
   ...
   End
End
Attribute VB_Name = "FormNDInterna"
...
Attribute VB_Exposed = False
 ...
 Dim rstNDIC As DAO.Recordset
 Dim rstNDID As DAO.Recordset
...
'        TextSubtotalFactura.Text = Format(total, "#,###,###,#0.00")
  ...
  '      If TextTipoFactura.Text = "A" Then
            percepcion = 0
            'subtotalFacturaForm * Alicuota / 100
...
Private Sub BotonGrabar_Click()
    ...
    '**************************************************
        ...
        rstDebIC.Seek "=", TextTipoFactura, Str(TextNumeroFactura.text)

        If Not rstDebIC.NoMatch Then
            A = MsgBox("Nota Debito Interna Existente", vbCritical, "INFO DEL SISTEMA")
        ...
        db1.Close
            ...
            rstNDIC.Fields!FechaDebitoI = TextFechaFactura.text
            rstNDIC.Fields!TotalDebitoI = TextTotalFactura.text
            rstNDIC.Fields!TotalDebitoI = TextTotalFactura.text
            rstNDIC.Fields!FechaVC = TextFechaFactura.text
            
            If Textiva.text <> "" Then
                rstNDIC.Fields!PorcentajeIVA = 0
                'Textiva.Text
            Else
                rstNDIC.Fields!PorcentajeIVA = "0,00"
            End If
            
           ' If ComboArticulo.Text = "GTO" Then
           '     If TextSubtotalFactura.Text = TextTotalFactura.Text Then TextSubtotalFactura.Text = (TextTotalFactura.Text / 1.21)
           '     rstNDIC.Fields!SubTotalDebito = Format(TextSubtotalFactura.Text, "#,###,###,#0.00")
           '     'If TextSubtotalFactura.Text = "" Then rstNDIC.Fields!SubTotalDebito = (rstNDIC.Fields!TotalDebito / 1.21)
           '     If TextImpuesto.Text <> "" Then
           '         rstNDIC.Fields!totalIva = Format(TextImpuesto.Text, "#,###,###,#0.00")
           '     Else
           '         rstNDIC.Fields!totalIva = Format((TextSubtotalFactura.Text * 21) / 100, "#,###,###,#0.00")
           '         '"0,00"
           '         'rstNDIC.Fields!TotalIVA = ((rstNDIC.Fields!SubTotalDebito) * 21) / 100
           '     End If
           '     If TextAlicuota.Text = "" Then TextAlicuota.Text = 0
           '     rstNDIC.Fields!AlicuotaIIBB = TextAlicuota.Text
           '     If TextPercepcionIIBB.Text <> "" Then
           '         rstNDIC.Fields!ImportePercepIIBB = TextPercepcionIIBB.Text
           '     End If
                
           '     Else
           '         If ComboArticulo.Text = "CHE" Then
                        rstNDIC.Fields!totalIva = Format(0, "#,###,###,#0.00")
                        rstNDIC.Fields!PorcentajeIVA = "0,00"
                        rstNDIC.Fields!SubTotalDebitoI = Format(TextTotalFactura.text, "#,###,###,#0.00")
                        rstNDIC.Fields!AlicuotaIIBB = Format(0, "#,###,###,#0.00")
           '         End If
           ' End If
            rstNDIC.Fields!CodCliente = TextCodigoCliente.text
'            rstNDIC.Fields!PorcentajeDesc = TextDescuentoCliente.Text
'            rstNDIC.Fields!ImporteDesc = TextDescuentos.Text
            ...
            Do While linea < Filas
                  ...
                  If FG1.text <> "" Then
                        ...
                        rstNDID.Fields!NroDebitoI = TextNumeroFactura.text
                        rstNDID.Fields!TipoDebitoI = TextTipoFactura.text
                    
                        FG1.Col = 0
                        rstNDID.Fields!IdCodProd = FG1.text
                    
                        FG1.Col = 2
                        rstNDID.Fields!UnidadMedida = FG1.text
                        
                        FG1.Col = 3
                        rstNDID.Fields!precioUnitario = Format(FG1.text, "#,###,###,#0.00")
                        
                        FG1.Col = 4
                        des = FG1.text
                        If des <> "" Then
                           rstNDID.Fields!PorcentajeDescuento = Val(des)
                        Else
                           rstNDID.Fields!PorcentajeDescuento = Val(TextDescuentoCliente.text)
                        End If
                        FG1.Col = 5
                        rstNDID.Fields!cantidad = Val(FG1.text)
                       ...
                       'Call DesHagoStock(CodProd, descuentoCantidad)
                        ...
                        FG1.Col = 6
                        rstNDID.Fields!totalLinea = Format(FG1.text, "#,###,###,#0.00")
                        
                        FG1.Col = 7
                        rstNDID.Fields!ImporteDescuento = 0
                        
                        FG1.Col = 8
                        rstNDID.Fields!ItemDebitoI = Val(FG1.text)
            ...
            If TextTipoFactura.text = "A" Then
                rstMovimientosCtaCte.Fields!tipoDoc = "Debito Int. A"
            End If
            ...
            If TextTipoFactura.text = "A" Then
                busco = "tNotaDebitoIntA"
            End If
            
            If TextTipoFactura.text = "B" Then
                busco = "tNotaDebitoIntB"
            End If
...
Private Sub Form_Load()
    ...
    FormNDInterna.Height = 10200
    FormNDInterna.Width = 12135
    FormNDInterna.Top = 600
    FormNDInterna.Left = 50
...
Private Sub calculoprecios()
    ...
    If TextCantidad.text <> "" Then
        ...
        precioUnitario = Format(TextPrecioUnitario.text, "#,###,###,#0.00")
...
'        porcentajePrecioUnitario = ((precioUnitario * porcentaje) / 100) * cantidad
'        totalLinea = total - ((total * porcentaje) / 100)
'        TextTotalLineaProd.Text = Format(totalLinea, "#,###,###,#0.00")
'        TextPorDesc.Text = Format(porcentajePrecioUnitario, "#,###,###,#0.00")
