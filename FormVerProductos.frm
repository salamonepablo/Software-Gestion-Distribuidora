     ...
     Set rstProductos = db.OpenRecordset("Productos", dbOpenDynaset)
      ...
      Do While linea < Filas
          ...
          If MSFlexGrid1.text <> " " Then
             ...
             MSFlexGrid1.Col = 3
             rstProductos.Fields!PrecioUnitarioPresupuesto = Format(MSFlexGrid1.text, "#,###,###,#0.00")
                            
             MSFlexGrid1.Col = 4
             rstProductos.Fields!PrecioUnitarioFactura = Format(MSFlexGrid1.text, "#,###,###,#0.00")
...
Private Sub muestrodatos()
    ...
    Do While Not rstProductos.EOF
        ...
        MSFlexGrid1.Row = linea2
            ...
            MSFlexGrid1.Col = 3
            MSFlexGrid1.text = Format(rstProductos.Fields!PrecioUnitarioPresupuesto, "#,###,###,#0.00")
            MSFlexGrid1.Col = 4
            MSFlexGrid1.text = Format(rstProductos.Fields!PrecioUnitarioFactura, "#,###,###,#0.00")
            linea2 = linea2 + 1
