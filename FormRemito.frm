...
'    Set RemD = BaseSPC.OpenRecordset(vSQLRd, dbOpenDynaset)
    ...
    'With p
        ...
        'Imprimir Fecha
            ...
            Printer.Print Format(FormRemito.TextFechaRemito.text, "DD/MM/YYYY")
        ...
        'Imprimir Nombres
           Printer.CurrentX = X + 40
            ...
            Printer.Print FormRemito.TextApellidoNombre.text
        ...
        'Imprimir Direccion
            ...
            Printer.FontSize = 10
            Printer.FontBold = False
            Printer.Print FormRemito.TextDireccion.text
        ...
        'Imprimir Localidad
            ...
            Printer.FontSize = 10
            Printer.FontBold = False
            Printer.Print FormRemito.TextLocalidad.text
        ...
        'Imprimir CUIT
            ...
            Printer.FontSize = 10
            Printer.FontBold = False
            Printer.Print FormRemito.TextCuit.text
...
Private Sub BotonGrabar_Click()
        ...
        Answer = MsgBox("¿Imprime el Remito?", vbYesNo, "SPCSI - Información al Usuario")
