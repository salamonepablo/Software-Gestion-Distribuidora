...
Begin VB.Form FormVerNotaDebitoIntCtaCte 
   ...
   End
End
Attribute VB_Name = "FormVerNotaDebitoIntCtaCte"
           ...
           If Not tNotaDebitoC.NoMatch Then
                ...
                With Printer
                    ...
                    'Datos de La Empresa y Comprobante
                        ...
                        NroFactura = CStr(tNotaDebitoC!NroDebitoI)
                        Largo = 8 - Len(tNotaDebitoC!NroDebitoI)
                        For I = 1 To Largo
                    ...
                    'Datos del Cliente
                     ...
                     'Recuadro Detalle
                       ...
                       'Imprimir Detalle de La Factura
                        ...
                        'vSQL = "SELECT * FROM NotaDebitoID WHERE NroDebito=" & tNotadebitoC!NroDebitoI & " ORDER BY NroDebitoI, ItemDebito"
                        vSQL = "SELECT * FROM NotaDebitoID WHERE TipoDebito='" & tNotaDebitoC!TipoDebitoI & "' AND NroDebito=" & tNotaDebitoC!NroDebitoI & " ORDER BY NroDebitoI, ItemDebito"
                        'MsgBox (vSQL)
...
Private Sub BotonSalir_Click()
    ...
    Unload FormVerNotaDebitoIntCtaCte
...
Private Sub Form_Load()
    ...
    FormVerNotaDebitoIntCtaCte.Height = 8970
    FormVerNotaDebitoIntCtaCte.Width = 12135
    FormVerNotaDebitoIntCtaCte.Top = 1000
    FormVerNotaDebitoIntCtaCte.Left = 1000
    
    numDoc = Val(FormMovimientosCuentaCorriente.TextNumeroDocumento)
    tipoDoc = Right(FormMovimientosCuentaCorriente.TextTipodocumento, 1)
    codCli = Val(FormMovimientosCuentaCorriente.TextCodigoCliente)
    
    
    
'    numDoc = Val(FormMovimientosCuentaCorriente.Text)
'    tipoDoc = FormMovimientosCuentaCorriente.extNumeroFactura
'    codCli = Val(FormMovimientosCuentaCorriente.TextCodigoCliente)
...
Private Function CalcularBarCode() As String
    ...
    If tNotaDebitoC!TipoDebitoI = "A" Then TipoC = "02"
    If tNotaDebitoC!TipoDebitoI = "B" Then TipoC = "07"
