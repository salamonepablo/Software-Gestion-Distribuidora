...
Begin VB.Form MenuPrincipal 
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.CommandButton cmdRemTemp 
         ...
         Width           =   1575
      End
      Begin VB.CommandButton cmdReportConsignas 
         Caption         =   "&Lista Consignas"
         BeginProperty Font 
            Name            =   "MS Sans Serif"
            Size            =   8.25
            Charset         =   0
         ...
         Width           =   1035
      End
      Begin VB.CommandButton cmdNotaDebito 
      ...
      Begin VB.CommandButton cmdNDInterna 
         Caption         =   "Notas de Débito Interna"
         BeginProperty Font 
            Name            =   "MS Sans Serif"
            Size            =   8.25
            Charset         =   0
...
Private Sub cmdConsignas2_Click()
...
Private Sub cmdNDInterna_Click()
...
Private Sub cmdProveedores_Click()
    ...
    FormIngresoFacturas.Show
    'mdiproveedores.Show

End Sub

Private Sub cmdRemTemp_Click()

    FormRemitoTemporal.Show

End Sub

Private Sub cmdReportConsignas_Click()

    FormListadoConsignas.Show
...
Private Sub ListClientes_Click()
    FormListadoClientesPorVendedor.Show
End Sub
