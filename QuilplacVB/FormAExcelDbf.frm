...
Begin VB.Form FormAExcelDbf 
   Caption         =   "Exportacion de Percepciones a Clientes a Excel"
   ClientHeight    =   5670
   ClientLeft      =   120
   ClientTop       =   450
   ClientWidth     =   10740
   ...
   End
End
Attribute VB_Name = "FormAExcelDbf"
...
'On Error GoTo Error_Handler
    ...
    Set db = OpenDatabase("Q:\DATOS\", False, False, "DBASE V")
'   et base = OpenDatabase("c:\ruta", False, False, "DBASE IV")
    'Set tabla = base.OpenRecordset("tutabla", dbOpenDynaset)
      
    Desde = "#" & Format$(TxtFechaDesde.Text, "mm/dd/yyyy") & "#"
    Hasta = "#" & Format$(TxtFechaHasta.Text, "mm/dd/yyyy") & "#"
    
    eseqele = "SELECT * FROM facturas WHERE fechafactura >=" & Desde & " AND fechafactura <=" & Hasta & " Order By nrofactura, fechafactura"
    
    'Set rst = db.OpenRecordset(eseqele, dbOpenDynaset)
    Set rst = db.OpenRecordset("facturas", dbOpenDynaset)
