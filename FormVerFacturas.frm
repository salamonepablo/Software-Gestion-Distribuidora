...
'    rstFacturaD.FindFirst "NroFactura= " + Str(numDoc)
   ...
   While Not rstFacturaD.EOF
            ...
            FG1.Col = 3
            FG1.text = Format(rstFacturaD.Fields!precioUnitario, "#,###,###,#0.00")
            FG1.Col = 4
            FG1.text = rstFacturaD.Fields!PorcentajeDescuento
            FG1.Col = 5
            FG1.text = rstFacturaD.Fields!cantidad
            FG1.Col = 6
            FG1.text = Format(rstFacturaD.Fields!totalLinea, "#,###,###,#0.00")
    ...
    TextDescuentos.text = Format(rstFacturaC.Fields!ImporteDesc, "#,###,###,#0.00")
