...
Begin VB.Form FormVerFactura 
   ...
   End
End
Attribute VB_Name = "FormVerFactura"
...
Private Sub Form_Load()
    ...
    FormVerFactura.Height = 8970
    FormVerFactura.Width = 12135
    FormVerFactura.Top = 1000
    FormVerFactura.Left = 1000
...
'    If TextDireccion.text <> "" Then TextDireccion.text = rstCliente.Fields!Domicilio
'    If TextLocalidad.text <> "" Then TextLocalidad.text = rstCliente.Fields!localidad
'    If TextCodigoPostal.text <> "" Then TextCodigoPostal.text = rstCliente.Fields!CP
'    If TextProvincia.text <> "" Then TextProvincia.text = rstCliente.Fields!Prov
...
'    rstFacturaD.FindFirst "NroFactura= " + Str(numDoc)
    ...
    vSQL = "SELECT * FROM FacturaD WHERE TipoFactura='" & tipoDoc & "' AND NroFactura=" & numDoc & " ORDER BY ItemFactura"

    'rstFacturaD.Index = "PrimaryKey"

    'rstFacturaD.Seek "=", tipoDoc, Str(numDoc)
    
    Set rstFacturaD = db2.OpenRecordset(vSQL, dbOpenDynaset)
    
    rstFacturaD.MoveFirst

    linea2 = 1
   While Not rstFacturaD.EOF
            FG1.AddItem " "
            FG1.Row = linea2
