...
Begin VB.Form FormImprimirNC 
   ...
   End
End
Attribute VB_Name = "FormImprimirNC"
...
Private Function CalcularBarCode() As String
  ...
  '  MsgBox (FechaVC)
    ...
    CalcularBarCode = "30708432543" & TipoC & "0003" & tNotaCreditoC!CAE & FechaVC & CalculoDigitoVerificador("30708432543")
...
Private Sub ImprimirFED()
        ...
        'Buscar en bbdd
           ...
           Set tFacturaC = BaseSPC.OpenRecordset("NotaCreditoC", dbOpenTable)
'          Set tFacturaD = BaseSPC.OpenRecordset("FacturaD", dbOpenTable)
           Set tClientes = BaseSPC.OpenRecordset("Clientes", dbOpenTable)
           Set tDomiciliosClientes = BaseSPC.OpenRecordset("DomiciliosClientes", dbOpenTable)
...
Private Sub BotonSalir_Click()
    ...
    Call FormNotaCredito.blanqueototal
        
    FormNotaCredito.TextCodigoCliente.SetFocus
    FormNotaCredito.MSFlexGrid1.Visible = False
           
    Unload FormImprimirNC
...
Private Sub cmdFacturaEl_Click()
        ...
        Dim vVal As Double
        vVal = Shell(App.Path & "\NotaCredito.exe " & TextNumeroFactura.Text & " " & TextTipoFactura.Text, 1)
...
Private Sub Form_Load()
    ...
    TextNumeroFactura.Text = vNroNCImp
    TextNumeroRemito.Text = vNroRemNCImp
    TextTipoFactura.Text = vTipoNCImp
