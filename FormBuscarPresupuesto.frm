...
Private Sub TextNumeroFactura_KeyPress(KeyAscii As Integer)
        ...
        'Set rstPresupuestoC = db1.OpenRecordset("PresupuestoC", dbOpenTable)
        'rstPresupuestoC.Index = "PrimaryKey"
            
        If KeyAscii = 13 Then
             rstPresupuestoC.FindFirst "NroPresu= " + Str(numDoc)
             'rstPresupuestoC.Seek "=", numDoc
             If rstPresupuestoC.Fields!NroPresu <> Val(TextNumeroFactura.text) Then
             'If rstPresupuestoC.NoMatch Then
