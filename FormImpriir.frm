...
'//////////////////////// IMPRESION DE ORIGINAL /////////////////////////////////////////////////////////////////////////
        ...
        '//IMPRESION DE COMENTARIOS ADICIONALES 01/04/2025
                            .FontBold = False
                            .FontName = "Arial"
                            .ForeColor = vbBlack
                            .FontSize = 8
...
Private Sub GenerarFE()
        ...
        Dim NroRemito As String
        Dim vSQL As String
        Dim Largo, LargoAclaracion As Integer
        Dim LargoR As Integer
        Dim linea As Integer
        Dim PU, TL, Cant, SubTotalFac, ImpIva, ImpIIBB, TotalFac As Variant
        Dim Original As Integer
        Dim tCmp As Long
        Dim DirectorioQRs As String
        Dim AclaracionFactura As String
           ...
           If Not tFacturaC.NoMatch Then
                ...
                'IMPRESION DE HOJA ORIGINAL
                    ...
                    'Datos de La Empresa y Comprobante
                        ...
                        'If IdSucursal <> 0 Then
                        '    Printer.Print IdSucursal & "-" & NroFactura
                        ' Else
                        '    IdSucursal = InputBox("Ingrese Nº Sucursal", "SPC SI")
                        'End If
...
'                                Printer.Print "0002-" & NroRemito
                                ...
                                If tFacturaC!IdSucursal = "" Then IdSucursal = 0
