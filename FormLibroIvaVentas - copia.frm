...
'    Close #1
   ...
   'Ahora las NOTA DE DEBITO
    ...
    While Not rstSIAP.EOF
        'Punto 01 Tipo de Comprobante
             If rstSIAP!TipoDebito = "A" Then linea = linea & "003"
...
On Error GoTo Error_Handler
  ...
  If Not rstND.EOF Then rstND.MoveFirst
   ...
   While Not rstND.EOF
         ...
         MSFlexGrid2.Col = 7
         MSFlexGrid2.Text = Format(rstND.Fields!SubTotalDebito, "#00.00")
         neto = rstND.Fields!SubTotalDebito
         MSFlexGrid2.Col = 8
         MSFlexGrid2.Text = Format(rstND.Fields!ImportePercepIIBB, "#00.00")
         percepcion = rstND.Fields!ImportePercepIIBB
         MSFlexGrid2.Col = 9
         'iva = (neto * 21) / 100
         iva = Format(rstND.Fields!totalIva, "#00.00")
         MSFlexGrid2.Text = Format(iva, "#00.00")
         'total = neto + percepcion + iva
         total = Format(rstND.Fields!TotalDebito, "#00.00")
         MSFlexGrid2.Col = 10
         MSFlexGrid2.Text = Format(total, "#00.00")
